...
cond_names = ['Gain_amb', 'Gain_risk', 'Loss_amb', 'Loss_risk']
cont1 = ('Gain_Amb', 'T', cond_names, [1, 0, 0, 0])
cont2 = ('Gain_Risk', 'T', cond_names, [0, 1, 0, 0])
cont3 = ('Gain_Amb > Gain_Risk', 'T', cond_names, [1, -1, 0, 0]) 

cont4 = ('Loss_Amb', 'T', cond_names, [0, 0, 1, 0])
cont5 = ('Loss_Risk', 'T', cond_names, [0, 0, 0, 1])
cont6 = ('Loss_Amb > Loss_Risk', 'T', cond_names, [0, 0, 1, -1])

cont7 = ('Gain>Loss_Amb', 'T', cond_names, [1, 0, -1, 0])
cont8 = ('Gain>Loss_Risk', 'T', cond_names, [0, 1, 0, -1])

cont9 = ('Gain>Loss', 'T', cond_names, [1, 1, -1, -1])
cont10 = ('Amb>Risk', 'T', cond_names, [1, -1, 1, -1])

cont11 = ('All', 'T', cond_names, [1, 1, 1, 1])

cont12 = ('Gain_Total', 'T', cond_names, [1, 1, 0, 0])
cont13 = ('Loss_Total', 'T', cond_names, [0, 0, 1, 1])

cont14 = ('Risk_Total', 'T', cond_names, [0, 1, 0, 1])
cont15 = ('Amb_Total', 'T', cond_names, [1, 1, 0, 0])
#contrasts = [cont1, cont2, cont3, cont4, cont5, cont6, cont7, cont8, cont9, cont10, cont11]
contrasts = [cont12, cont13, cont14, cont15]
...
datasource.inputs.field_template = dict(func = 'R_A_ID_BIDS/derivatives/sub-%s/ses-1/func/sub-%s_ses-1_task-%s_space-MNI152NLin2009cAsym_res-2_desc-preproc_bold.nii.gz',
                                        mask = 'R_A_ID_BIDS/derivatives/sub-%s/ses-1/func/sub-%s_ses-1_task-%s_space-MNI152NLin2009cAsym_res-2_desc-brain_mask.nii.gz',
                                        regressors = 'R_A_ID_BIDS/derivatives/sub-%s/ses-1/func/sub-%s_ses-1_task-%s_desc-confounds_timeseries.tsv',
                                        events = 'event_files/sub-%s_ses-1_task-%s_cond.csv')
