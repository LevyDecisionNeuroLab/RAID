...
#
#SBATCH --j RAID_10_11 # job name
#SBATCH --array=1-2 # number of participants as range starting at 1 (i.e., for 5 participants: 1-5)
...
BASE_DIR="/home/cyx3/RAID" # not really used, not sure why is it here
BIDS_DIR="/home/cyx3/RAID/RAID_Bids" # Location of the bids folder.
